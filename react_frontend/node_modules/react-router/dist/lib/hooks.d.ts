...
import type { Blocker, BlockerFunction, Location, ParamParseKey, Params, Path, PathMatch, PathPattern, RelativeRoutingType, Router as RemixRouter, RevalidationState, To, UIMatch } from "../../../../react_frontend/node_modules/@remix-run/router";
import { Action as NavigationType } from "../../../../react_frontend/node_modules/@remix-run/router";
 ...
 */
export declare function useNavigation(): import("../../../../react_frontend/node_modules/@remix-run/router").Navigation;
/**
